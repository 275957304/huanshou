...
<div class="wrap">
    ...
    <div class="pt">
        ...
        <div class="pt_info">
            <p class="n1">评选周期：每个星期一期。</p>
            <p class="n2">官方会根据幻兽战斗力评选，排名前3名的勇士可获得“御龙至尊”称号6天，排行4-10名的勇士可获得“御龙至尊”称号3天。
</p>  
			<p style="background-position: -595px -499px;" class="n1">连续7期排行第一的勇士可额外获得暗金升阶哥布林一只，连续30期排行第一的勇士可额外获得暗金幻兽一只。</p>
        </div>
    </div>
</div>
							...
							if(response.success){
								...
								if(response.data){
									...
									$.each(response.data, function(i,n){
										$('#rankList').append('<li><span class="r1">' + (i+1) + '</span><span class="r2">' + n.data.server_name + '</span><span class="r3">' + n.data.role_name + '</span><span class="r4">' + n.data.title + '</span><span class="r5">' + n.data.power + '</span></li>');   
									});
								}
